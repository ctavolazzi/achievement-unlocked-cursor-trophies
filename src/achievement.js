/**
 * Achievement Unlocked - Xbox 360-style notifications
 * https://github.com/ctavolazzi/achievement-unlocked-cursor-trophies
 * 
...
const Achievement = {
    ...
    unlock(title = "Achievement Unlocked", gamerscore = 50, description = "") {
        ...
        window.dispatchEvent(new CustomEvent('achievement-unlocked', {
            detail: { title, gamerscore, description, timestamp: Date.now() }
        }));
    ...
    test() {
        this.unlock("Test Achievement", 10, "The system is working!");
    }
};
